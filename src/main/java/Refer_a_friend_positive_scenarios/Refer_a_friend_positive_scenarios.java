...
public class Refer_a_friend_positive_scenarios extends Generic_function{
	...
	public static void refer_a_frnd_positive_tc_008() throws Exception   {
		try {
			...
			value = driver.findElement(By.xpath(OR_reader("Object_Locator", "refer_a_frnd_carousal_to"))).isDisplayed();
			Assert.assertEquals(true,value);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static void refer_a_frnd_positive_tc_010() throws Exception   {
		try {
			...
			e.printStackTrace();
			takeScreenShot("refer_a_frnd_positive_tc_010");
		}
	}
}
